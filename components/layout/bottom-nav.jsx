...
export function BottomNav({ activeView, setActiveView }) {
  ...
  return (
    <div className="md:hidden fixed bottom-0 left-0 right-0 w-full z-[100] bg-white/95 backdrop-blur-xl border-t border-gray-200 pt-1.5 pb-[calc(6px+env(safe-area-inset-bottom))] flex items-center justify-evenly px-3 shadow-[0_-4px_16px_rgba(0,0,0,0.03)]">
