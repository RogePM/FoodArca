...
export default function TrustPricingSection() {
    ...
    const tiers = {
        ...
        enterprise: {
            ...
            description: "Unlimited team members and locations. Seamlessly manage inventory across multiple facilities with advanced routing and real-time synchronization."
        }
    };
