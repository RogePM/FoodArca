...
export default function SubpageHero({ 
  ...
  return (
    // Extra top padding (pt-32 to pt-40) to account for your fixed NavBar
    <section className="relative pt-32 pb-16 lg:pt-40 lg:pb-24 bg-[#FAFAF9] overflow-hidden">
      ...
      <div className="container mx-auto px-6 max-w-[85rem]">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-20">
          ...
          <div className="w-full lg:w-1/2 flex flex-col items-start text-left z-10">
            ...
            <h1 
              className="animate-in fade-in slide-in-from-bottom-4 duration-700 text-4xl sm:text-5xl md:text-6xl font-serif text-[#1C1917] leading-[1.1] tracking-tight mb-6"
            >
          ...
          >
            {/* The colored background box (mimicking the dark blue box in your reference) */}
            <div className="absolute top-4 -right-4 bottom-4 left-12 bg-[#1C1917] rounded-[2rem] -z-10 rotate-1 opacity-5"></div>
            
            {/* Main Background Image */}
            <div className="relative w-full aspect-[4/3] rounded-2xl md:rounded-[2rem] border border-[#E7E5E4] shadow-2xl overflow-hidden bg-white ml-auto">
              <Image
                src={mainImageSrc}
