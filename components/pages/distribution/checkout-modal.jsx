...
export function CheckoutModal({ isOpen, onClose, cart, onSuccess }) {
  ...
  const enableClientTracking = false; // Client CRM removed from current scope
  ...
  const handleCheckout = async () => {
    ...
    const cartItems = cart.map(line => ({
      itemId: line.item.id || line.item._id,
      catalogItemId: line.item.catalogItemId || line.item.catalog_item_id || line.item.id || line.item._id,
