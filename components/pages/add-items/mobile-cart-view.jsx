      ...
      <div className="flex-1 overflow-y-auto w-full pb-[calc(110px+env(safe-area-inset-bottom))]">
        {cartItems.length === 0 ? (
          ...
          <div className="flex flex-col">
            ...
            <div className="bg-white shrink-0 relative z-20 border-b border-gray-200 shadow-[0_2px_6px_rgba(0,0,0,0.03)] mb-2.5">
              <div className="px-4 pt-[calc(env(safe-area-inset-top)+8px)] pb-2 flex items-center justify-between">
                <div className="flex flex-col">
            ...
            <button
              ...
              className="fixed bottom-[calc(70px+env(safe-area-inset-bottom))] right-4 z-[90] w-12 h-12 bg-[#e27f2c] rounded-full shadow-[0_3px_12px_rgba(226,127,44,0.3)] flex items-center justify-center text-white hover:bg-[#cf6f20] active:scale-95 transition-transform cursor-pointer"
