            ...
            <div className="p-4 bg-white border-b border-gray-200 z-10 shrink-0 shadow-sm">
                <div className="flex items-center justify-between mb-3">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <Switch 
                            checked={isAnonymous} 
                            onCheckedChange={(val) => { setIsAnonymous(val); resetRecipient(); }} 
                        ...
                        <div className="flex gap-2">
                            <div className="relative flex-1">
                                ...
                                <Input 
                                    ...
                                    className={`pl-9 h-11 bg-white border-2 rounded-xl transition-all font-medium text-base md:text-sm ${
                                        selectedClient 
                            ...
                            <Button
                                ...
                                className={`h-11 w-11 p-0 rounded-xl border-2 transition-all shrink-0 ${
                                    isNewClient 
